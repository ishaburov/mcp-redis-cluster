...
async def get_indexes() -> str:
    ...
    try:
        ...
        r = RedisConnectionManager.get_connection()
        return f"Error retrieving indexes: {append_cluster_error_hint(r, e)}"
...
async def get_index_info(index_name: str) -> str:
    ...
    try:
        ...
        r = RedisConnectionManager.get_connection()
        return f"Error retrieving index info: {append_cluster_error_hint(r, e)}"
...
async def get_indexed_keys_number(index_name: str) -> str:
    ...
    try:
        ...
        r = RedisConnectionManager.get_connection()
        return f"Error retrieving number of keys: {append_cluster_error_hint(r, e)}"
...
async def create_vector_index_hash(
    ...
    try:
        ...
        r = RedisConnectionManager.get_connection()
        return f"Error creating index '{index_name}': {append_cluster_error_hint(r, e)}"
...
async def vector_search_hash(
    ...
    try:
        ...
        r = RedisConnectionManager.get_connection()
        return (
            f"Error performing vector search on index '{index_name}': "
...
async def hybrid_search(
    ...
    try:
        ...
        r = RedisConnectionManager.get_connection()
        return (
            f"Error performing hybrid search on index '{index_name}': "
            f"{append_cluster_error_hint(r, e)}"
        )
